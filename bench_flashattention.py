...
# our flash
# our flash
minimal_flash = load(name='flash', sources=['src/main.cpp', 'src/flashattention.cu'], extra_cuda_cflags=['-D_GLIBCXX_USE_CXX11_ABI=0', '-g'], extra_cflags=['-g'], extra_include_paths=['/usr/local/cuda/include'], extra_ldflags=['-L/usr/lib/x86_64-linux-gnu', '-g'], build_directory="./cuda_build")
# integrate llm.c
...
print(minimal_flash.shape)

print(torch.exp(manual_result).shape)
